      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="mt-20 sm:mt-32 pt-16 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <div className="text-center md:text-right space-y-2">
            <p className="text-slate-500 text-[10px] font-medium uppercase tracking-[0.2em]">© {new Date().getFullYear()} {appConfig.associationName || "Al Kendi"}. Tous droits réservés.</p>
            <p className="text-slate-600 text-[9px] font-black uppercase tracking-[0.3em]">
              Site créé par <span className="text-primary">Rayan El Moatadide</span>
            </p>
          </div>
        </div>
      </div>
